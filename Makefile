...
%shader.js: %shader.glsl src/sample/webgl/shader.mustache tasks/glslunit.js
	@node tasks/glslunit.js --input $< | ./node_modules/.bin/mustache - src/sample/webgl/shader.mustache > $@

%shader/Locations.js: %shader.glsl src/ol/webgl/shaderlocations.mustache tasks/glslunit.js
	@mkdir -p $(@D)
	@node tasks/glslunit.js --input $< | ./node_modules/.bin/mustache - src/sample/webgl/shaderlocations.mustache > $@
